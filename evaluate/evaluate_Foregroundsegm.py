...
def get_args():
    ...
    parser.add_argument('--output_dir', default='C:/Users/70241/PycharmProjects/visual_prompting-main/evaluate/result/ForegroundSegm')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--base_dir', default='C:/Users/70241/PycharmProjects/visual_prompting-main/figures_dataset', help='pascal base dir')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--t', default=[0, 0, 0], type=float, nargs='+')
    parser.add_argument('--task', default='segmentation', choices=['segmentation', 'detection'])
    parser.add_argument('--ckpt', default='C:/Users/70241/PycharmProjects/visual_prompting-main/output_dir/checkpoint-1000.pth',help='model checkpoint')
