...
def get_args():
    ...
    parser.add_argument('--output_dir', default='C:/Users/70241/PycharmProjects/visual_prompting-main/evaluate/result/Colorization')
    parser.add_argument('--data_path',default='C:/Users/70241/PycharmProjects/visual_prompting-main/figures_dataset/imagenet')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--tta_option', default=0, type=int)
    parser.add_argument('--ckpt',default='C:/Users/70241/PycharmProjects/visual_prompting-main/output_dir/checkpoint-1000.pth', help='resume from checkpoint')
