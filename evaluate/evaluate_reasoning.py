...
def get_args():
    ...
    parser.add_argument('--output_dir', default='C:/Users/70241/PycharmProjects/visual_prompting-main/evaluate/result/reasoning/')
...
def calculate_metric(args, target, ours):
    ...
    assert colors.shape[0] == 3, colors # white and the expected color
