...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='C:/Users/70241/PycharmProjects/visual_prompting-main/figures_dataset/dataset', type=str,
                        help='dataset path')
...
def main(args):
    ...
    dataset_train = datasets.ImageFolder(os.path.join(args.data_path, 'train'), transform=transforms_train)
    print(dataset_train)
